...
import {
  ...
  AlertTriangle, Store, Settings, X, LogOut, DollarSign, Sprout, MessageCircle
} from 'lucide-react';
...
export function Sidebar({ activeTab, setActiveTab, isOpen, setIsOpen }: SidebarProps) {
  ...
  const mainNav = [
    ...
    { id: 'disease-detection', label: 'Crop Health Scan',   icon: Activity, badge: 'AI' },
    { id: 'consultations',     label: 'Ask an Expert',      icon: MessageCircle, badge: 'AI' },
    { id: 'weather-intel',     label: 'Weather Intel',      icon: CloudSun },
    { id: 'alerts',            label: 'Alerts & Prices',    icon: AlertTriangle, badgeCount: unreadCount },
  ];

  const secondaryNav = [
    { id: 'finances',    label: 'Finances',   icon: DollarSign },
    { id: 'marketplace', label: 'Buy Inputs', icon: Store },
  ];
